...
const AP_Param::Info Rover::var_info[] PROGMEM = {
    ...
    // boat
    // @Param: rudder_min
    // @DisplayName: rudder channel minimum
    // @Description: minimum output for rudder
    // @Values: 
    // @User: Advanced
	GSCALAR(rudder_min,        "RUDDER_MIN", 600),

    // boat
    // @Param: rudder_mid
    // @DisplayName: rudder channel mid
    // @Description: maximum output for rudder
    // @Values: 
    // @User: Advanced
	GSCALAR(rudder_mid,        "RUDDER_MID", 1300),

    // boat
    // @Param: rudder_max
    // @DisplayName: rudder channel maximum
    // @Description: maximum output for rudder
    // @Values: 
    // @User: Advanced
	GSCALAR(rudder_max,        "RUDDER_MAX", 2000),

    // boat
    // @Param: sail_min
    // @DisplayName: sail channel minimum
    // @Description: minimum output for sail
    // @Values: 
    // @User: Advanced
	GSCALAR(sail_min,          "SAIL_MIN", 600),

    // boat
    // @Param: sail_mid
    // @DisplayName: sail channel mid
    // @Description: mid output for sail
    // @Values: 
    // @User: Advanced
	GSCALAR(sail_mid,          "SAIL_MID", 1300),
    
    // boat
    // @Param: sail_max
    // @DisplayName: sail channel maximum
    // @Description: maximum output for sail
    // @Values: 
    // @User: Advanced
	GSCALAR(sail_max,          "SAIL_MAX", 2000),

    // boat
    // @Param: target_apparent
    // @DisplayName: target apparent
    // @Description: target value for apparent wind
    // @Values: 
    // @User: Advanced
	GSCALAR(target_apparent,    "TARGET_APPARENT", 450),

    // boat
    // @Param: target_course
    // @DisplayName: target course
    // @Description: target value for course compas course
    // @Values: 
    // @User: Advanced
	GSCALAR(target_course,    "TARGET_COURSE", 0),
    
    // boat
    // @Param: sail_mode
    // @DisplayName: sailing control mode
    // @Description: Determines whether the APM controls the rudder to maintain the apparent wind angle or controls rudder and sail to maintain the course
    // @Values: 0:MANUAL,1:APPARENT,2:COURSE
    // @User: Advanced
	GSCALAR(target_mode,      "TARGET_MODE",     0),
    ...
    // @Values: 
    // @User: Advanced
	GSCALAR(wind_mid,          "WIND_MID", 1300),
    ...
    // @Values: 
    // @User: Advanced
	GSCALAR(wind_max,          "WIND_MAX", 1924),
    ...
    // @Values: 
    // @User: Advanced
	GSCALAR(sail_angle,          "SAIL_ANGLE", 450),    
    ...
    // @Values: 
    // @User: Advanced
	GSCALAR(sail_step,          "SAIL_STEP", 30),    
